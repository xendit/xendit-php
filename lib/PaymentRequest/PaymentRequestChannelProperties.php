    ...
    */
    ...
    public function setPendingReturnUrl($pending_return_url)
    {
        ...
        if ((!preg_match("/^\\S{1,255}:\/\/\\S{0,1000}$/", $pending_return_url))) {
            throw new \InvalidArgumentException("invalid value for \$pending_return_url when calling PaymentRequestChannelProperties., must conform to the pattern /^\\S{1,255}:\/\/\\S{0,1000}$/.");
        }
